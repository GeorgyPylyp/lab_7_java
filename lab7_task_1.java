...
public class lab7_task_1 {
    ...
    public static void main(String[] args) {
        ...
        MetroStationDatabase metroStationDatabase = new MetroStationDatabase();
    ...
    private static void editHour(Scanner scanner, MetroStationDatabase metroStationDatabase) {
    ...
    private static void searchHour(Scanner scanner, MetroStationDatabase metroStationDatabase) {
    ...
    private static void sortHours(Scanner scanner, MetroStationDatabase metroStationDatabase) {
